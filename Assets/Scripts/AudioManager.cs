...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] private Slider musicVolumeSlider1;
    [SerializeField] private Slider musicVolumeSlider2;
    ...
    private void Start()
    {
        dayMusicSource.Play();
        OnGamePaused();
        musicVolumeSlider1.value = AudioManager.Instance.musicVolume;
        musicVolumeSlider2.value = AudioManager.Instance.musicVolume;
    }
    ...
    public void SetSFXAndMusicVolume(float volume)
    {
        SetSFXVolume(volume);
